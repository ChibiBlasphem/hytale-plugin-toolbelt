...
val dev by sourceSets.creating {
    ...
    compileClasspath += files(main.output, configurations.getByName("compileClasspath"))
    runtimeClasspath += files(output, compileClasspath)
}

configurations.getByName(dev.implementationConfigurationName)
    .extendsFrom(configurations.getByName("implementation"))
configurations.getByName(dev.compileOnlyConfigurationName)
